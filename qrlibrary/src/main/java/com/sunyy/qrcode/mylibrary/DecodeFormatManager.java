...
final class DecodeFormatManager {
  ...
  static Set<BarcodeFormat> parseDecodeFormats(Bundle intent) {
    Iterable<String> scanFormats = null;
    CharSequence scanFormatsString = intent.getString(Intents.Scan.FORMATS);
    if (scanFormatsString != null) {
      scanFormats = Arrays.asList(COMMA_PATTERN.split(scanFormatsString));
    }
    return parseDecodeFormats(scanFormats, intent.getString(Intents.Scan.MODE));
  }
